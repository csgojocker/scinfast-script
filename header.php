...
<header>
	...
	<div class="top">
		...
		<a href="/" class="logotype left"><img src="/styles/images/logo.png" alt="image"></a>

<ul class="menu left">
				<li><a href="/top.php"><?=$msg['top_winner']?></a></li>
				<li><a href="/history.php"><?=$msg['see_history']?></a></li>
				<li><a href="/about.php"><?=$msg['about']?></a></li>
				<li><a href="mailto: maximula0@gmail.com" target="_blank" class="" id="wints"><?=$msg['help']?></a></li>
				<li><a href="http://vk.com/scinfast" target="_blank" class="" id="wints"><?=$msg['vkgroup']?></a></li>
			</ul>
	...
	<div class="language_switcher">
		<a href="ru.php" title="ru" class="lang_ru"></a>
		<a href="en.php" title="en" class="lang_en"></a>
	</div>
