...
<!-- <middle> -->
	<div class="middle">
				...
				<div class="text1">
					<div class="title"><?=$msg['head']?></div><?=$msg['head2']?></div>

			<div class="stat">
				<div class="block"><div id="inf1">0</div> <?=$msg['online']?> </div>
			
<script>
/*
$(document).onload(function(){
var nikita = $('#inf1').html();
...
//намудрил)
				...
				<div class="block"><div id="inf10">~ 200 руб.</div><?=$msg['max_wins']?></div>
			</div>
...
<div class="rightbar hiddenes" id="trade_link">
	...
	<div class="rightbar" id="rightbar">
		...
		<div class="settings-game">
			...
			<div class="timer"><?=$msg['do_start'] ?><div id="timer">01:30</div></div>
			<div class="progress">
        ...
        ?>	<div class="inform">
            <div class="icon"><span id="chance-temp">0</span>%</div>
			<div class="text"><div><?=$msg['you_vnes']?> <span id="player-items-count">0</span> из 12 <?=$msg['veshey']?></div><?=$msg['min_dep']?> <?=$msg['min-10rub']?>  <span id="currency"></span> <?=$msg['max_veshey']?> 12 <?=$msg['veshey']?></div>
			<div class="right">
        ...
        ?>	<div class="right">
				<a href="/deposit" target="_blank" class="add-item left"><?=$msg['deposite_one']?></a>
			</div>	<?php 
...
<div class="game-start-icon"><div class="game-start">
